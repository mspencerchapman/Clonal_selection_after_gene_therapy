...
#Plot the overall sample signatures
...
#Write vcfs of all sample mutations
...
#Now do vcfs of just developmental mutations
...
#Re-import these VCFs for SNV analysis
...
#Re-import these VCFs for Indel analysis
...
#Now import the mutational signature extraction data
...
##Check the strand bias of the N2 signature - SBS19-like
#This is most prevalent in SCD2 (BCL009) and the predominant feature is C>T mutations at CpT sites
...
#Now test for strand bias for the distinctive N5 mutations
...
#Review the averages for each sample & time point
...
##LOOK CLOSELY AT CORRELATION BETWEEN N5 and HYDROXYCARBAMIDE EXPOSURE
...
#Now assess differently - looking at the proportion of mutations that are the distinctive feature of the "N5" signature
